"""Deterministic graph — fixed node order, single tool call per turn.

Used for high-precision intents (search / detail / order / FAQ / refund).
"""
...
def build_deterministic_graph(*, with_checkpointer: bool = True):
    ...
    g.add_edge("reflect", "memory_update")
